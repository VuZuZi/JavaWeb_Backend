...
public class UserDAO implements IUserDAO {
    ...
    private static String jdbcURL = "jdbc:mysql://localhost:3306/userManager?useSSL=false";
...
//        }
    ...
    public static void main(String[] args) {
        ...
        try {
            dao.getConnection();
            List<User> lsit =  dao.searchByCountry("lao");
            for (int i = 0; i < lsit.size(); i++) {
                System.out.println(lsit.get(i).getName());
            }
        }catch (Exception e){
